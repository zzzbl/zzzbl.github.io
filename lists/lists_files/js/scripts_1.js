...
$("button").click(function(){
    ...
    if (b == answer1) {
        $("#capital").css("background-color","#00FF00");
        $("#capital").css("color","white");
    } else {
        $("#capital").css("background-color","#CC0000"); 
        $("#capital").css("color","white");
    }
    
    if (c == answer2) {
        $("#population").css("background-color","#00FF00");     
    } else {
        $("#population").css("background-color","#CC0000"); 
        $("#population").css("color","white");
    }
    
    if (d == answer3) {
        $("#founder").css("background-color","#00FF00");     
    } else {
        $("#founder").css("background-color","#CC0000"); 
        $("#founder").css("color","white");
    }
